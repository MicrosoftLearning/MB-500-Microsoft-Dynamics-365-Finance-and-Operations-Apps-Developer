...
8.  If needed, download the file by selecting **Save As** and store it in the **Downloads**
    folder.
...
6.  Enter a new record: Enter **100** in the field **Vendor group**, **Insurance Vendor** in the

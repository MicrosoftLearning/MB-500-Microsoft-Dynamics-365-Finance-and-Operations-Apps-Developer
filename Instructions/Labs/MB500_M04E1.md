...
12. Right click on **MBTPeriod** in the editor (designer).
...
8.  Right click on **MBTAssetInsuranceID** in the editor (designer).
...
3.  Set **Allow Duplicates** to **No** and **Alternate Key** to **Yes**.

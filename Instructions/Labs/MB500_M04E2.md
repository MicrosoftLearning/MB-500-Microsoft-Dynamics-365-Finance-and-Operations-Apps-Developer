---
lab:
    title: 'Exercise 02: User interface development'
    module: 'Learning Path 04: AOT Elements'
---
...
9.  In the Properties pane set the **Name** property to
...
27. In the **Properties** pane of the **Identification** group control under
    **DetailsGroup** enter the following **property:**
...
30. In the **Properties** pane of the **General TabPage** control under
    **DetailsTab** enter the following **property:**
...
32. In the **Properties** pane of the **Policy** Group control under
    **DetailsTab \> General tabpage** enter the following **property:**
...
36. In the **Properties** pane of the **Description** Group control under
    **DetailsTab \> Notes tabpage** enter the following **property:**
...
1.  In your project MB500TrainingProjectUI in the Solution Explorer, add a **New
    Item** in **User Interface** of type **Display Menu Item**, and Name it
